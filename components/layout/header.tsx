        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-border/20 rounded-b-2xl mt-2 overflow-hidden shadow-xl bg-card/95 backdrop-blur-xl"
            >
              <div className="px-4 pt-4 pb-6 space-y-2">
                {navigation.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.href}
                      className="block px-4 py-3 text-base font-medium text-foreground/90 hover:text-foreground hover:bg-primary/15 rounded-xl transition-all duration-150 border border-transparent hover:border-primary/20"
                ...
                >
                  <Button
                    asChild
                    size="sm"
                    className="w-full bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-accent shadow-lg transition-all duration-150"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
