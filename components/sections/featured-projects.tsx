                  ...
                  <CardContent className="p-8 lg:p-12">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="relative">
                        <div className="aspect-video bg-gradient-to-br from-primary/20 to-secondary/20 rounded-xl overflow-hidden transition-transform duration-200 hover:scale-[1.02]">
                          {featuredProjects[currentIndex]?.images && featuredProjects[currentIndex]?.images[0] ? (
                            <Image
                              src={featuredProjects[currentIndex].images[0] || "/placeholder.svg"}
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex gap-3">
                          <Button asChild size="sm" className="group transition-all duration-200">
                            <Link href={featuredProjects[currentIndex]?.live || "#"}>
                              <ExternalLink className="mr-2 h-4 w-4 group-hover:scale-110 transition-transform duration-200" />
                              Live Demo
                            </Link>
                          </Button>
                          <Button
